...
/**
 * The mod_partforum assessable uploaded event.
 *
...
/**
 * The mod_partforum assessable uploaded event class.
 *
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has posted content in the partforum post with id '$this->objectid' " .
            "in the discussion '{$this->other['discussionid']}' located in the partforum with course module id " .
    ...
    protected function get_legacy_eventdata() {
        ...
        $eventdata->modulename   = 'partforum';
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'mod_partforum');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/partforum/discuss.php', array('d' => $this->other['discussionid'], 'parent' => $this->objectid));
    }

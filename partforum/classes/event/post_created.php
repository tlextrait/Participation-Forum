...
/**
 * The mod_partforum post created event.
 *
...
/**
 * The mod_partforum post created event class.
 *
...
class post_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostcreated', 'mod_partforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'partforum', 'add post', $logurl, $this->other['partforumid'], $this->contextinstanceid);
    }
